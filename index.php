...
<head>
  ...
  <meta property="og:title" content="Nakanoya 吉兵衛 - 公式ホームページ"/>
  <meta property="og:description" content="Nakanoya吉兵衛の公式ホームページです"/>
  <meta property="og:type" content="website"/>
  <meta property="og:url" content="https://nakanoya-kichiheibei.com"/>
  ...
  <meta name="description" content="Nakanoya吉兵衛の公式ホームページです">
  <title>Nakanoya 吉兵衛 - 公式ホームページ</title>
  ...
  <main>
      ...
      <?php while ($the_query->have_posts()): $the_query->the_post(); ?>
        <div class="room_item">
          ...
          <div class="room_text">
            ...
            <dl>
              <dt>アメニティ</dt>
              <dd><?php echo CFS()->get('information_room_amenities'); ?></dd>
            </dl>
            <dl>
              <dt>食事</dt>
              <dd><?php echo CFS()->get('information_room_meal'); ?></dd>
            </dl>
            <dl>
              <dt>トイレ・シャワー</dt>
    ...
    <section class="contact" id="contact">
      ...
      <div class="tel">
        ...
        <a href="tel:080-5960-5935"><?php echo CFS()->get('contact_tel'); ?></a>
      </div>
      <p>お問い合わせ時間</p>
  ...
  <footer>
    <div class="footer_contents">
      ...
      <div class="infomation">
        <p>〒906-0007</p>
        <p>沖縄県宮古島市平良東仲宗根95</p>
        <p>TEL : 080-5960-5935 (受付時間 0:00 ~ 0:00)</p>
        <p>MAILL : mail@gmail.com</p>
      </div>
      <?php endwhile; ?>
      <?php wp_reset_postdata(); ?>
      <?php else: ?>
